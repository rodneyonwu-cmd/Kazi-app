...
export default function ProviderSettings() {
  ...
  return (
    <div className="kazi-settings">
      ...
      <div className="card">
        <div className="row" onClick={() => navigate('/account/hourly-rate')}><div className="row-icon"><svg viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg></div><div className="row-body"><div className="row-label">Hourly rate</div></div><span className="row-value" style={{color:'var(--green)',fontWeight:800}}>$28/hr</span><ChevRight /></div>
        <div className="row" onClick={() => navigate('/account/travel-radius')}><div className="row-icon"><svg viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg></div><div className="row-body"><div className="row-label">Travel radius</div></div><span className="row-value">15 miles</span><ChevRight /></div>
        <div className="row" onClick={() => navigate('/account/minimum-shift')}><div className="row-icon"><svg viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /></svg></div><div className="row-body"><div className="row-label">Minimum shift length</div></div><span className="row-value">4 hours</span><ChevRight /></div>
