  ...
  return (
    <div className="kazi-settings">
      ...
      <div className="card">
        ...
        <div className="row" onClick={() => navigate('/account/name')}><div className="row-icon"><svg viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg></div><div className="row-body"><div className="row-label">Name</div><div className="row-sub">{fullName}</div></div><ChevRight /></div>
